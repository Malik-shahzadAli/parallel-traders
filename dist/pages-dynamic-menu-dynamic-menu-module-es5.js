...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["pages-dynamic-menu-dynamic-menu-module"], {
  ...
  function srcAppPagesDynamicMenuDynamicMenuComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var _shared_content_header_content_header_component__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(
    ...
    function DynamicMenuComponent_mat_error_8_Template(rf, ctx) {
      if (rf & 1) {
    ...
    function DynamicMenuComponent_mat_error_9_Template(rf, ctx) {
      if (rf & 1) {
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "mat-error");
    ...
    function DynamicMenuComponent_mat_option_12_Template(rf, ctx) {
      if (rf & 1) {
    ...
    function DynamicMenuComponent_mat_error_15_Template(rf, ctx) {
      if (rf & 1) {
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "mat-error");
    ...
    function DynamicMenuComponent_mat_error_20_Template(rf, ctx) {
      if (rf & 1) {
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "mat-error");
    ...
    function DynamicMenuComponent_mat_option_30_Template(rf, ctx) {
      if (rf & 1) {
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "mat-option", 20);
      ...
      if (rf & 2) {
        var menuItem_r126 = ctx.$implicit;
    ...
    DynamicMenuComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({
      ...
      template: function DynamicMenuComponent_Template(rf, ctx) {
        if (rf & 1) {
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("ngSubmit", function DynamicMenuComponent_Template_form_ngSubmit_5_listener($event) {
      ...
      encapsulation: 2,
      data: {
        animation: [_theme_utils_app_animation__WEBPACK_IMPORTED_MODULE_8__["blockTransition"]]
      }
    });
    /*@__PURE__*/

    (function () {
      _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵsetClassMetadata"](DynamicMenuComponent, [{
  ...
  function srcAppPagesDynamicMenuDynamicMenuModuleTs(module, __webpack_exports__, __webpack_require__) {
    ...
    DynamicMenuModule.ɵmod = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineNgModule"]({
      type: DynamicMenuModule
    });
    DynamicMenuModule.ɵinj = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineInjector"]({
      factory: function DynamicMenuModule_Factory(t) {
        return new (t || DynamicMenuModule)();
      },
    ...
    (function () {
      (typeof ngJitMode === "undefined" || ngJitMode) && _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵsetNgModuleScope"](DynamicMenuModule, {
        declarations: [_dynamic_menu_component__WEBPACK_IMPORTED_MODULE_5__["DynamicMenuComponent"]],
        imports: [_angular_common__WEBPACK_IMPORTED_MODULE_1__["CommonModule"], _angular_forms__WEBPACK_IMPORTED_MODULE_3__["FormsModule"], _angular_forms__WEBPACK_IMPORTED_MODULE_3__["ReactiveFormsModule"], _angular_router__WEBPACK_IMPORTED_MODULE_2__["RouterModule"], _shared_shared_module__WEBPACK_IMPORTED_MODULE_4__["SharedModule"]]
      });
    })();
    /*@__PURE__*/
    ...
    (function () {
      _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵsetClassMetadata"](DynamicMenuModule, [{
  ...
  function srcAppPagesDynamicMenuDynamicMenuServiceTs(module, __webpack_exports__, __webpack_require__) {
    ...
    DynamicMenuService.ɵfac = function DynamicMenuService_Factory(t) {
      return new (t || DynamicMenuService)(_angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵinject"](_angular_core__WEBPACK_IMPORTED_MODULE_0__["ComponentFactoryResolver"]), _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵinject"](_angular_core__WEBPACK_IMPORTED_MODULE_0__["ApplicationRef"]), _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵinject"](_angular_core__WEBPACK_IMPORTED_MODULE_0__["Injector"]));
    };

    DynamicMenuService.ɵprov = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineInjectable"]({
      token: DynamicMenuService,
      factory: DynamicMenuService.ɵfac
    });
    /*@__PURE__*/

    (function () {
      _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵsetClassMetadata"](DynamicMenuService, [{
